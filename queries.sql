...
*/
SELECT SUM(weight_kg) / COUNT(*) AS weight_kg_average
FROM animals;
/*
...
SELECT weight_kg
FROM animals
ORDER BY weight_kg ASC LIMIT 1;
SELECT weight_kg
FROM animals
...
*/
SELECT SUM(escape_attempts) / COUNT(*) AS escape_attempts_average
FROM animals
WHERE species = 'digimon' AND date_of_birth BETWEEN '1990-01-01' AND '2000-12-31';
SELECT SUM(escape_attempts) / COUNT(*) AS escape_attempts_average
FROM animals
WHERE species = 'pokemon' AND date_of_birth BETWEEN '1990-01-01' AND '2000-12-31';
